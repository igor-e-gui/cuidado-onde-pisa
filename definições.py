frases = {
    'reiniciado': '***Jogo reiniciado (progresso do jogador apagado). Digite "iniciar" para recomeçar a história.***',
    'saindo': 'Daisy\nDaisy',
...
estados = {
    ...
    6: {
        'frases': ['Você analisa e vê que não é normal alguém estar cantando no meio de um mar aberto e decide não dar ouvidos à canção e opta por continuar o seu rumo…\nQuando alcançou a metade do dia, com o Sol no centro do céu, sente fome e vasculha a canoa, mais especificamente a lona em que encontrou o pedaço de madeira. Você encontra uma longa vara com uma pedra afiada na ponta e uma âncora de ferro.\n\n***Você tem duas opções para escolher:\nDigite “1” para pular ao mar para caçar um peixe ou digite "2" para continuar remando com a esperança de encontrar ajuda.\nCaso deseje recomeçar o jogo, digite "0".***'],
        'proximos_estados':{
            '1|"1"': 7,
            '2|"2"': 12,
            '0|"0"': 1,
    ...
    17:{
        'frases':['***Parabéns, jogador!!:smiley:\nNós, desenvolvedores do Cuidado Onde Pisa, agradecemos por jogar. Esperamos que tenha se divertido e lamentamos toda a sua perda de tempo :joy:\n\nDigite "reiniciar" para jogar novamente e se divirta descobrindo os outros finais!!***'],
        'proximos_estados':{
            '[Rr]einiciar|"[Rr]einiciar"': 1
        },
        'inventario':set()
